...
pngquant_error rwpng_read_image24(struct rwpng_data *in_buffer, png24_image* mainprog_ptr)
{
    ...
    png_set_read_fn(png_ptr, in_buffer, user_read_data);
 ...
 */
    ...
    double gamma;
    mainprog_ptr->gamma = png_get_gAMA(png_ptr, info_ptr, &gamma) ? gamma : SRGB_GAMMA;
    ...
    mainprog_ptr->file_size = in_buffer->bytes_read;
